...
The next step was to predict how the users would rate their experience on those topics, in other words, I simulated the ratings for the categories, such as for the doctors' reviews.
...
I intentionally chose completely different procedures ..
