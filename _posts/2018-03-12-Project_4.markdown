...
The next step was to predict how the users would rate their experience on those topics, in other words, I simulated the ratings for the potential subcategories of the procedures, such as for the doctors' reviews.
...
One possible approach to define the rating for the topic is the percent of posts that gave a positive comment in each treatment, similar to Rotten Tomatoes scores. I analyzed the sentiments of their reviews.
